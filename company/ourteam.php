    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
          ...
          <h1 class="page-title mb-0 fs-5 fw-600">Our Team</h1>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card mb-4 bg-transparent">
                  <div class="card-body">
                    <div class="title-border mb-4">
                      <h1 class="text-muted fw-600 fs-5">Invite</h1>
                    </div>
                    <table id="table1" class="table data-ourteam" style="width:100%">
                      <thead class="text-sm">
                          <tr>
                              <th>Name</th>
                              <th>Email</th>
                      ...
                      <tbody class="fw-500 text-s">
                          <tr>
                              ...
                              <td>
                                <a href="" class="invite-link text-green me-3 fw-500 text-decoration-none">Invite</a>
                              </td>
                          </tr>
                          <tr>
                              <td>Namaku Panjang Sekali Z</td>
                          ...
                          <tr>
                              ...
                              <td>Namaku.Panjang@gmail.com</td>
                              <td>
                                <a href="" class="invited-link text-yellow me-3 fw-500 text-decoration-none">Invited</a>
                                <a href="" class="revoke-link text-red me-3 fw-500 text-decoration-none">Remove</a>
                              </td>
                          </tr>
                          <tr>
                              <td>Namaku Panjang Sekali Z</td>
                ...
                <div class="card mb-4 bg-transparent">
                  <div class="card-body">
                    <div class="title-border mb-4">
                      <h1 class="text-muted fw-600 fs-5">Our Team</h1>
                    </div>
                    <table id="tableourteam" class="table data-ourteam" style="width:100%">
                      <thead class="text-sm">
                          <tr>
                              <th>Name</th>
                              <th>Email</th>
        ...
        new DataTable('#table1',{ 
          scrollX: true,
            "initComplete": function () {
                ...
                $('#table1_filter input').attr('placeholder', 'Search');
            }
        });
        
        new DataTable('#tableourteam',{ 
          scrollX: true,
            "initComplete": function () {
                // Add placeholder to the search input
                $('#tableourteam_filter input').attr('placeholder', 'Search');
            }
        });

    ...
    <body>
        ...
        <main id="main">
            <section id="hero-loker-list" class="hero-loker-list py-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 co-md-8 col-lg-9">
                            ...
                            <div class="hero-loker-list__wrapper">
                                <div class="hero-loker-list__item p-3 p-lg-4 mt-5">
                                    <div class="row">
                                        <div class="flex-grow-1 pe-2 col-sm-4">
                                            <div class="position-relative">
                                                ...
                                                <div class="position-relative">
                                                    <div class="fw-bold fs-5 mb-2">Senior UI Designer</div>
                                        ...
                                        <div class="hero-job-list__close-info col-sm-4 position-relative">

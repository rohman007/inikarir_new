                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 co-md-8 col-lg-8">
                                    ...
                                    <div class="button-grid-thumbnail me-2">
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none">
                                                <path d="M11 5H5V11H11V5Z" fill="#075256"/>
                                                <path d="M11 13H5V19H11V13Z" fill="#075256"/>
                                                <path d="M13 5H19V11H13V5Z" fill="#075256"/>
                                                <path d="M19 13H13V19H19V13Z" fill="#075256"/>
                                            </svg>
                                        </a>
                                    </div>
                                    <div class="button-list-thumbnail me-3 cursor-pointer button-active">
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none">
                                                <path d="M7.5 8C8.32843 8 9 7.32843 9 6.5C9 5.67157 8.32843 5 7.5 5C6.67157 5 6 5.67157 6 6.5C6 7.32843 6.67157 8 7.5 8Z" fill="#075256"/>
                                                <path d="M10 7H18V6H10V7Z" fill="#075256"/>
                                                <path d="M7.5 13.5C8.32843 13.5 9 12.8284 9 12C9 11.1716 8.32843 10.5 7.5 10.5C6.67157 10.5 6 11.1716 6 12C6 12.8284 6.67157 13.5 7.5 13.5Z" fill="#075256"/>
                                                <path d="M10 12.5H18V11.5H10V12.5Z" fill="#075256"/>
                                                <path d="M9 17.5C9 18.3284 8.32843 19 7.5 19C6.67157 19 6 18.3284 6 17.5C6 16.6716 6.67157 16 7.5 16C8.32843 16 9 16.6716 9 17.5Z" fill="#075256"/>
                                                <path d="M18 18H10V17H18V18Z" fill="#075256"/>
                                            </svg>
                                        </a>
                                    </div>
                                    <div class="sort-loker d-flex align-items-center">
                                        <div class="text-xs text-muted me-1" style="line-height:normal">Sort by:</div>
                                        <select class="border-0 text-sm">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mb-3">
                                                <div class="d-flex align-items-center loker-percentage">
                                                    ...
                                                    <div class="circle-wrap">
                                                        <div class="circle">
                                                        <div class="mask full" style="transform: rotate(calc(180 * 0.9deg));">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.9deg));"></div>
                                                        </div>
                                                        <div class="mask half">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.9deg));"></div>
                                                        </div>
                                        ...
                                        <div class="hero-job-list__close-info col-sm-4">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mb-3">
                                                <div class="d-flex align-items-center loker-percentage">
                                                    ...
                                                    <div class="circle-wrap">
                                                        <div class="circle">
                                                        <div class="mask full" style="transform: rotate(calc(180 * 0.75deg));">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.75deg));"></div>
                                                        </div>
                                                        <div class="mask half">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.75deg));"></div>
                                                        </div>
                                        ...
                                        <div class="hero-job-list__close-info col-sm-4">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mb-3">
                                                <div class="d-flex align-items-center loker-percentage">
                                                    ...
                                                    <div class="circle-wrap">
                                                        <div class="circle">
                                                        <div class="mask full" style="transform: rotate(calc(180 * 0.25deg));">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.25deg));"></div>
                                                        </div>
                                                        <div class="mask half">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.25deg));"></div>
                                                        </div>
                                        ...
                                        <div class="hero-job-list__close-info col-sm-4">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mb-3">
                                                <div class="d-flex align-items-center loker-percentage">
                                                    ...
                                                    <div class="circle-wrap">
                                                        <div class="circle">
                                                        <div class="mask full" style="transform: rotate(calc(180 * 0.1deg));">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.1deg));"></div>
                                                        </div>
                                                        <div class="mask half">
                                                            <div class="fill" style="transform: rotate(calc(180 * 0.1deg));"></div>
                                                        </div>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-loker justify-content-center mt-5">

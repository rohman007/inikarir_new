                ...
                <div class="form-block bg-white d-sm-flex rounded-3 py-sm-5 py-4 px-sm-5 px-3 my-3">
                    <div class="form-block pe-3 ps-2 col-12 col-sm-5 col-md-5 d-none d-sm-flex">
                        <div class="image-form overflow-hidden rounded-4 d-flex overflow-hidded">
                            <img src="./assets/images/hero-option.jpg" class="form-image w-100 object-fit-cover">
                        </div>
                    </div>
                    <div class="px-3 col-12 col-sm-7 col-md-6 text-sm ps-sm-5">
                        <a class="navbar-brand" href="#">
                            <img src="./assets/images/logo.png" alt="Ini Karir" style="width:55px !important"/>
                        </a>
                        <h1 class="fw-700 fs-3 text-black mt-4 mb-3">Hallo Joko,</h1>
                        <p class="fw-500 mb-5 text-xs">It’s a great day, what will you access this time ?</p>
                            <a href="#" class="mb-5 button-option d-flex justify-content-between align-items-center text-decoration-none btn btn-primary bg-white text-start text-sm py-3 rounded-4 px-3">
                                <div class="d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 50 50" fill="none">
                                    <circle cx="24.6787" cy="24.6741" r="24.3994" fill="#C4C4C4"/>
                                    </svg>
                                    <div class="ms-3">
                                        <div class="fw-600 text-black">Create Personal Profile</div>
                                        <div class="text-muted">Joko Purwanto</div>
                                    </div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.2676 4.91418L13.5474 6.63434L20.3549 13.454H5.50781V15.8939H20.3549L13.5474 22.7136L15.2676 24.4337L25.0273 14.674L15.2676 4.91418Z" fill="#898989"/>
                                </svg>
                            </a>
                            <div class="label-login-others text-muted text-center position-relative my-5"><span class="px-2 bg-white text-xs position-relative">Or create</span></div>

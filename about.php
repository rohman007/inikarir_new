            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <p class="text-sm text-black col-sm-9 mx-auto px-2">Focus on growing your enterprise, and let us handle the complex details of the hiring process. We are committed to ensuring you can concentrate on what matters most - developing your business, while we take care of sourcing, screening, and placing top-notch talent tailored to your needs.</p>

                        <div class="mt-4 d-flex gap-3 justify-content-center">
                            <a href="#" class="btn btn-primary text-xs fw-bold px-3 py-2 rounded-4">Consult Now</a>
                            <a href="#" class="btn btn-outline-primary text-xs fw-bold px-3 py-2 rounded-4">Learn More</a>
                        </div>
                    </div> <!-- /.col-lg-5 -->
                </div> <!-- /.row -->
            </div> <!-- /.container -->

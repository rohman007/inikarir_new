        ...
        <main id="main">
            <section id="search-result" class="hero-loker-list py-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-tile mb-4">
                                <h1 class="fs-4 fw-700">Search Result</h1>
                            </div>
                            <div class="no-result py-5 text-center fs-4 fw-600 mb-4">You haven't done a search yet</div>
                        </div>
                    </div>
                </div>
            </div>
            <section id="hero-loker-list" class="hero-loker-list py-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-tile mb-4">
                                <h1 class="fs-4 fw-700">Personalized For You</h1>
                            </div>
                        </div>

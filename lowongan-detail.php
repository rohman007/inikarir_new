                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-8 hero-loker-detail__content ps-md-5 mb-5 mb-sm-0">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30" fill="none">
                                    <g clip-path="url(#clip0_750_994)">
                                    <path d="M26.8481 6.88497L15.5112 0.140537C15.1962 -0.0468457 14.8038 -0.0468457 14.4887 0.140537L3.15182 6.88497C2.84883 7.06526 2.66309 7.39186 2.66309 7.74442V11.5944C2.66309 19.7035 7.34824 27.1098 14.6389 29.9325C14.871 30.0224 15.1287 30.0225 15.361 29.9325C22.6339 27.1169 27.3367 19.7266 27.3367 11.5944V7.74442C27.3368 7.39181 27.1511 7.06526 26.8481 6.88497ZM19.9404 12.7529L13.6729 19.0204C13.2824 19.411 12.6492 19.411 12.2587 19.0204L10.0591 16.8209C9.66855 16.4304 9.66855 15.7972 10.0591 15.4067C10.4496 15.0162 11.0828 15.0162 11.4733 15.4067L12.9657 16.8991L18.5262 11.3387C18.9166 10.9482 19.5499 10.9482 19.9404 11.3387C20.331 11.7293 20.331 12.3624 19.9404 12.7529Z" fill="#075256"/>
                                    </g>
                                    <defs>
                                    <clipPath id="clip0_750_994">
                            ...
                            <div class="text-muted text-sm mb-4 ">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla euismod, libero vel fringilla hendrerit, ex purus accumsan dui, in luctus dolor arcu dictum arcu. Etiam quis libero tellus. Vestibulum imperdiet enim ut bibendum fringilla. Nulla porta fringilla metus, vel gravida tellus fringilla sed. Vestibulum posuere eros ac purus tempus, nec aliquet lorem bibendum.</p>
                            </div>
                            <div class="fs-5 mb-2 mt-4 fw-bold">Job Description</div>
                            <div class="text-muted text-sm mb-4">
                                <ul class=" text-sm">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="d-flex mb-2">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 20" fill="none">
                                                <g opacity="0.75" clip-path="url(#clip0_750_1034)">
                                                <path d="M13.5634 11.7661L10.7748 9.67474V5.4145C10.7748 4.98614 10.4286 4.63989 10.0002 4.63989C9.57184 4.63989 9.22559 4.98614 9.22559 5.4145V10.0621C9.22559 10.3061 9.34023 10.5361 9.53543 10.6818L12.6338 13.0056C12.7732 13.1101 12.9359 13.1605 13.0978 13.1605C13.334 13.1605 13.5664 13.0543 13.7182 12.8499C13.9755 12.5082 13.9057 12.0225 13.5634 11.7661Z" fill="#0E0B33"/>
                                                <path d="M10 0C4.48566 0 0 4.48566 0 10C0 15.5143 4.48566 20 10 20C15.5143 20 20 15.5143 20 10C20 4.48566 15.5143 0 10 0ZM10 18.4508C5.34082 18.4508 1.54918 14.6592 1.54918 10C1.54918 5.34082 5.34082 1.54918 10 1.54918C14.66 1.54918 18.4508 5.34082 18.4508 10C18.4508 14.6592 14.6592 18.4508 10 18.4508Z" fill="#0E0B33"/>
                                                </g>
                                                <defs>
                                                <clipPath id="clip0_750_1034">
                                                <rect width="20" height="20" fill="white"/>
                                                </clipPath>
                                                </defs>
                                            </svg>
                                            </span>
                                            <span class="ps-2">Monday - Friday</span>
                                        </div>
                                        <div class="d-flex mb-2">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
                        ...
                        <div class="col-12 col-sm-12 mt-5 mb-4">
                            ...
                            <div class="hero-loker__slider d-flex grid-thumbnail">
                                ...
                                <div class="mx-2 mx-lg-2 swiper hero-loker__slider-swiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide p-2 px-2">
                                            <div class="hero-loker-list__item w-100 p-3 p-lg-4 mt-4 mx-0">
                                                <div class="row">
                                                        ...
                                                        <div class="position-relative">
                                                            ...
                                                            <div class="position-relative">
                                                                ...
                                                                <div class="hero-loker-list__company">
                                                                    ...
                                                                    <path d="M20.1542 5.73748L10.7068 0.117114C10.4442 -0.0390381 10.1172 -0.0390381 9.85469 0.117114L0.407276 5.73748C0.154785 5.88772 0 6.15989 0 6.45369V9.66204C0 16.4196 3.9043 22.5915 9.97984 24.9438C10.1732 25.0187 10.388 25.0188 10.5816 24.9438C16.6424 22.5974 20.5614 16.4388 20.5614 9.66204V6.45369C20.5614 6.15984 20.4067 5.88772 20.1542 5.73748ZM14.3978 10.6274L9.17486 15.8504C8.84942 16.1758 8.32178 16.1758 7.99634 15.8504L6.16333 14.0174C5.83789 13.692 5.83789 13.1643 6.16333 12.8389C6.48877 12.5135 7.01646 12.5135 7.34185 12.8389L8.58555 14.0826L13.2192 9.44891C13.5446 9.12352 14.0723 9.12352 14.3978 9.44891C14.7233 9.77439 14.7233 10.302 14.3978 10.6274Z" fill="#F3E035"/>
                                                                    </svg>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="hero-loker__swiper-next swiper-circle__navigation-next d-flex align-items-center justify-content-center">
                                    <div class="d-flex align-items-center justify-content-center rounded-circle shadow-sm bg-white">
